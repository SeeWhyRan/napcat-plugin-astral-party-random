...
import RandomOpeningPage from './pages/RandomOpeningPage'
import { useStatus } from './hooks/useStatus'
import { useTheme } from './hooks/useTheme'

export type PageId = 'status' | 'config' | 'groups' | 'random-opening'
...
const pageConfig: Record<PageId, { title: string; desc: string }> = {
    ...
    'random-opening': { title: '随机开局', desc: '管理全局预设（所有人可用）' }
}
...
function App() {
    ...
    const renderPage = () => {
        switch (currentPage) {
            ...
            case 'random-opening': return <RandomOpeningPage />
